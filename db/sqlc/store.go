...
func (store *Store) executeTransaction(ctx context.Context, function func(*Queries) error) error {
...
// It creates the transfer, add account entries, and update account balances within a database transaction
